Scaling [cybersecurityrtms-3f10] With Kubernetes
===========================

Generated On: 2026-05-30 20:40:31 UTC
...
Based on your TML solution [cybersecurityrtms-3f10] - if you want to scale your application with Kubernetes - you will need to apply the following YAML files.

.. list-table::

   * - **YML File**
     - **Description**
   * - :ref:`cybersecurityrtms-3f10.yml`
   ...
   * - :ref:`qdrant.yml`
     - This is the Qdrant deployment YAML.
       ...
       applied if using Step 9 DAG.
   * - :ref:`nginx-ingress-cybersecurityrtms-3f10.yml`
     - If you are scaling your TML solution you must

       apply the nginx-ingresscybersecurityrtms-3f10.yml; this yaml is 
...
.. code-block:: YAML
   ...
   kubectl apply -f kafka.yml -f secrets.yml -f mysql-storage.yml -f mysql-db-deployment.yml -f cybersecurityrtms-3f10.yml

cybersecurityrtms-3f10.yml
------------------------

.. important::
   Copy and Paste this YAML file: cybersecurityrtms-3f10.yml - and save it locally.

   These YML files can also be found on GitHub at: https://github.com/smaurice101/raspberrypitss/tree/main/tml-airflow/dags/tml-solutions/cybersecurityrtms-3f10/ymls/cybersecurityrtms-3f10
...
.. code-block:: YAML
   ...
   ################# cybersecurityrtms-3f10.yml
     ...
     kind: Deployment
     metadata:
       name: cybersecurityrtms-3f10
     spec:
       selector:
         matchLabels:
           app: cybersecurityrtms-3f10
       ...
       template:
         ...
         spec:
           containers:
           - name: cybersecurityrtms-3f10
             image: maadsdocker/cybersecurityrtms-3f10-amd64:latest
             volumeMounts:
             - name: dockerpath
             ...
             - name: SOLUTIONNAME
               value: 'cybersecurityrtms-3f10'
             - name: SOLUTIONDAG
               value: 'solution_preprocessing_dag-cybersecurityrtms-3f10'
             - name: GITUSERNAME
               value: 'smaurice101'
             - name: GITREPOURL
             ...
             - name: step3localfiledocfolder # STEP 3 # STEP 3 docfolder inputfile field can be adjusted here.
               value: '/rawdatademo/mylogsdemo,/rawdatademo/mylogs2demo'               
             ...
             - name: step4clocalsearchtermfolder # STEP 4c 
               value: '|/rawdatademo/mysearchfile1demo,|/rawdatademo/mysearchfile2demo'                              
   ...
   ---
     ...
     kind: Service
     metadata:
       name: cybersecurityrtms-3f10-visualization-service
       labels:
         app: cybersecurityrtms-3f10-visualization-service
     spec:
       type: ClusterIP
       ports:
...
.. code-block::
   ...
   kubectl port-forward deployment/cybersecurityrtms-3f10 6060:6060
...
.. important::
   ...
   **STEP 4:  Apply nginx-ingress-cybersecurityrtms-3f10.yml to your kubernetes cluster.  First you need to save it locally then apply it:**

nginx-ingress-cybersecurityrtms-3f10.yml
-------------
   ...
   .. code-block::
      ...
      kubectl apply -f nginx-ingress-cybersecurityrtms-3f10.yml
...
.. code-block::
   ...
   http://tml.tss/viz/dashboard-rtms.html?topic=rtms-preprocess&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
